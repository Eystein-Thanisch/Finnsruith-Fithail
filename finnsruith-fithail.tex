...
\begin{enumerate}
  ...
  \item[n\emph{ir}t] \Aendnote{gen. of nert \enquote{strength}}
  ...
  \item[\emph{f\emph{or} fonaidm}] \Aendnote{fo-naidm vn. of fo-naisc DIL F 287.061 \enquote{pledge, bond guarantee} 
\end{enumerate}
  ...
  \item[dethb\emph{ir}us] \Aendnote{deth \enquote{good} + birus (?)}
