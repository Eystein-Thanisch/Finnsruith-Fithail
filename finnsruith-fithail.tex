...
\begin{enumerate}
  ...
  \item[himforc\emph{r}adha] im + forcrad + a \enquote{excess}
  ...
  \item[imarc\emph{r}adho] imar \enquote{intenstifier} DIL I 107.021 + cradho \enquote{goods/property and of various payments} DIL C 542.020. the o-ending is interesting and needs checking with early modern grammatical tracts.
\end{enumerate}
\end{document}
